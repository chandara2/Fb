    ...
    <div class="container-fluid mt-5">
        <form action="{{ route('admin.job.update', $jobid->id) }}" method="POST">
            ...
            <div class="form-group row mb-md-3">
                ...
                <div class="col-xl-6 col-md-8 mb-md-0 mb-sm-2">
                    <select name="job_industries" value="{{ $jobid->job_industries }}" class="form-select">
            ...
            <div class="form-group row mb-md-3">
                ...
                <div class="col-xl-6 col-md-8 mb-md-0 mb-sm-2">
                    <select name="job_function" value="{{ $jobid->job_function }}" class="form-select">
            ...
            <div class="form-group row mb-md-3">
                ...
                <div class="col-xl-6 col-md-8 mb-md-0 mb-sm-2">
                    <input type="number" name="hiring" value="{{ $jobid->hiring }}" autofocus class="form-control" placeholder="5">
