...
@section('content')
    ...
    <div class="container">
        <div class="row">
            <button type="submit" data-bs-toggle="modal" data-bs-target="#showSlideModal" class="btn btn-sm btn-primary mb-3 rounded-0 w-auto"><i class="bi bi-plus-square-dotted"></i> Partner</button>
        </div>
